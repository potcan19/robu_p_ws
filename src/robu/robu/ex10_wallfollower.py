...
ROBOT_DIRECTION_LEFT_FROND_INDEX=315
ROBOT_DIRECTION_RIGTH_FRONT_INDEX =45
ROBOT_DIRECTION_LEFT_INDEX =270
ROBOT_DIRECTION_RIGTH_INDEX =90
ROBOT_DIRECTION_REAR_INDEX =180
ROBOT_DIRECTION_LEFT_REAR_INDEX =225
ROBOT_DIRECTION_RIGTH_INDEX =135
...
class WallFollower(rclpy.Node):
    def __init__(self):
        ...
        self.timer=self.create_timer(0.2,slef.timer_callback)
    ...
    def scan_callback(self, msg):
        ...
        self.leftfront_dist=msg.ranges[ROBOT_DIRECTION_LEFT_FROND_INDEX]
        self.front_dist=msg.ranges[ROBOT_DIRECTION_FRONT_INDEX]
        self.rightfront_dist=msg.ranges[ROBOT_DIRECTION_RIGTH_FRONT_INDEX]
        self.right_dist=msg.ranges[ROBOT_DIRECTION_RIGTH_INDEX]
